...
function affirm(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      ...
      case /* HaveBeenCalledTimes */13 :
          var match$36 = param[0];
          if (match$36[0] >= 826472012) {
            var match$37 = match$36[1];
            return expect(match$37[0]).toHaveBeenCalledTimes(match$37[1]);
          } else {
            var match$38 = match$36[1];
            return expect(match$38[0]).not.toHaveBeenCalledTimes(match$38[1]);
          }
      case /* Throws */14 :
      ...
      case /* ObjectContains */26 :
          ...
          if (match$54[0] >= 826472012) {
            ...
            return expect(match$55[0]).toEqual(Curry._1(objectContaining, match$55[1]));
          } else {
            var match$56 = match$54[1];
            return expect(match$56[0]).not.toEqual(Curry._1(objectContaining, match$56[1]));
          }
      case /* ObjectMatch */27 :
...
function toHaveBeenCalledTimes(b, p) {
  return /* HaveBeenCalledTimes */Block.__(13, [mapMod((function (a) {
                    return /* tuple */[
                            a,
                            b
                          ];
